---
title: "Steps in the Book \"R in Action\""
...
# The fitted values are those that form abline
fitted(lm1)
weight
#Residuals are differences from observed values from mean values (fitted values)
residuals(lm1)
